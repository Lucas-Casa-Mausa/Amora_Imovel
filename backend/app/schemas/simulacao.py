...
class SimulacaoInput(BaseModel):
    ...
    percentual_entrada: float = Field(ge=5, le=20, description="Percentual de entrada (5 a 20)")
    anos_contrato: int = Field(ge=1, le=5, description="Duração do contrato (1 a 5 anos)")
